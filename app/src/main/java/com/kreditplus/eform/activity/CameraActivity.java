...
public class CameraActivity extends BaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (bundle.getInt(FRAME) == FRAME_KTP) {
            ...
            setContentView(R.layout.activity_camera_ktp_frame);
            ButterKnife.bind(this);
            Glide.with(this).load(R.drawable.frame_ktp)
                    .diskCacheStrategy(DiskCacheStrategy.NONE)
                    .skipMemoryCache(true)
                    .into(ivFrameKTP);
            ivSwitch.setVisibility(View.GONE);
        } else if (bundle.getInt(FRAME) == FRAME_KTP_FACE) {
            this.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
            setContentView(R.layout.activity_camera_selfie);
            ButterKnife.bind(this);
            Glide.with(this).load(R.drawable.foto_diri_frame)
                    .diskCacheStrategy(DiskCacheStrategy.NONE)
                    .skipMemoryCache(true)
                    .into(ivFrameKTPFace);
            ivSwitch.setVisibility(View.VISIBLE);
        }else if (bundle.getInt(FRAME) == FRAME_OTHER) {
            this.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
            setContentView(R.layout.activity_camera_selfie);
            ButterKnife.bind(this);
            ivSwitch.setVisibility(View.VISIBLE);
...
//            cameraPreview.switchCamera();
            if(bundle.getInt(FRAME) == FRAME_OTHER) isOther = true;
            if(isFront){
                isFront = false;
            }else{
                isFront = true;
            }
            EventBus.getDefault().post(new SwitchCamera(isFront, isOther));
            finish();
        }
    }
    ...
    private void initCamera() {
        ...
        if (bundle.getInt(FRAME) == FRAME_KTP) {
        ...
        } else if (bundle.getInt(FRAME) == FRAME_KTP_FACE || bundle.getInt(FRAME) == FRAME_OTHER) {
            if(isFront){
            ...
            if(isOther) simpleCamera = new SimpleCamera(this, SimpleCamera.CameraFace.BACK);
        } else {
            simpleCamera = new SimpleCamera(this, SimpleCamera.CameraFace.BACK);
        }
                ...
                if (isTakingCameraImage) {
                    ...
                    asyncTaskTakePhoto = new AsyncTask<Void, Void, File>() {
                        ...
                        protected void onPostExecute(File file) {
                            ...
                            try {
                                compressedFile = new Compressor(CameraActivity.this)
