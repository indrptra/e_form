...
public class YesNoDialog extends BaseDialog {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        strEditKOP = getArguments().getString("editKop");

        if (strform.equalsIgnoreCase("Edit")){
          if(strEditKOP.equalsIgnoreCase("isEdit")){
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.btnLeft:
                ...
                break;
            case R.id.btnRight:
                if(strEditKOP == null || strEditKOP.isEmpty()){
                    EventBus.getDefault().post(new StatusSyncKendaraan(strstatus, strbtnLeft, strbtnRight));
                }
                dismiss();
                break;
